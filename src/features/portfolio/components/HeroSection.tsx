...
import { HeroParticlesCanvas } from "@/shared/components/3d/HeroParticlesCanvas";
...
export function HeroSection() {
  ...
  return (
    <section
      ref={heroRef}
      id="top"
      className="relative min-h-[90vh] pt-28 pb-16 md:pt-36 md:pb-24 flex flex-col justify-center overflow-hidden"
    >
      {/* Interactive WebGL Three.js Particle Constellation Canvas */}
      <HeroParticlesCanvas />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div ref={portraitRef} className="lg:col-span-4 relative group">
          ...
          <div className="lg:col-span-8 flex flex-col justify-between space-y-8">
            ...
            <div
              ref={tagRef}
              className="inline-flex items-center gap-2 text-xs font-mono text-muted-foreground uppercase tracking-wider"
            >
              <span>(About me)</span>
            </div>

            {/* Display Headline with Stagger capability */}
            <h1
              ref={headlineRef}
              className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-foreground leading-[1.08]"
            >
              I&apos;m <span className="text-primary">{PERSONAL_INFO.name}</span>, a {PERSONAL_INFO.role} based in{" "}
              {PERSONAL_INFO.locationShort}.
            </h1>

            {/* Tagline / Subtitle */}
            <p ref={descRef} className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-2xl leading-relaxed">
            ...
            <div
              ref={ctaBarRef}
              className="pt-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 border-t border-border/80"
            >
